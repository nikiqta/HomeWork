                ...
                <fieldset className='App'>
                    <div style={{display: 'inline-grid'}}>
                        ...
                        <Input
                            ...
                            valid={validObj.validConfirmEmail}
                        />
                        ...
                        <input
                            style={({"display": (validObj.validMail && validObj.validName && validObj.validPassword && validObj.validConfirmPassword && validObj.validConfirmEmail) === true ? '' : 'none'})}
                            type='submit'
